					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">(+92)302 3434418</li>
								<li class="icon solid fa-envelope"><a href="#">Webpenter@gmail.com</a></li>
								<li class="icon brands fa-twitter"><a href="#">twitter.com/webpenter</a></li>
								<li class="icon brands fa-facebook-f"><a href="#">facebook.com/webpenter</a></li>
								<li class="icon brands fa-instagram"><a href="#">instagram.com/webpenter</a></li>
							</ul>
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed By: Webpenter.com</li>
							</ul>
						</div>
					</section>
